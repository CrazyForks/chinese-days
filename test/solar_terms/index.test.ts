  ...
  describe('getSolarTermDate', () => {
    const testCases = [
      ...
      },
      {
        ...
        expected: '2026-02-18',
        century: 21,
        desc: '雨水 2026 (有delta调整)',
      }, // SOLAR_TERMS_DELTA 中包含 2026_rain_water: -1
      {
        year: 2024,
        month: 2,
        term: 'the_beginning_of_spring' as SolarTermKey,
        expected: '2024-02-04',
        century: 21,
        desc: '立春 2024 (无delta调整)',
      },
      {
        year: 1900,
        month: 1,
        term: 'greater_cold' as SolarTermKey,
        expected: '1900-01-21',
        century: 20,
        desc: '大寒 1900 (1月节气使用(Y-1)/4逻辑)',
      },
      {
        year: 2000,
        month: 12,
        term: 'the_winter_solstice' as SolarTermKey,
        expected: '2000-12-21',
        century: 20,
        desc: '冬至 2000 (20世纪)',
      },
      {
        year: 2001,
        month: 3,
        term: 'the_spring_equinox' as SolarTermKey,
        expected: '2001-03-20',
        century: 21,
        desc: '春分 2001 (21世纪)',
      },
      // 测试 (Y-1)/4 与 Y/4 对L值计算产生差异的情况
      {
        ...
        term: 'lesser_cold' as SolarTermKey,
        expected: '2001-01-05',
        desc: '小寒 2001, Y=1, (Y-1)/4 = 0',
      }, // Y=1 时, (Y-1)/4=0, Y/4=0。此处 L 值无差异。
      {
        year: 2004,
        month: 1,
        term: 'lesser_cold' as SolarTermKey,
        expected: '2004-01-06',
        desc: '小寒 2004, Y=4, (Y-1)/4 = 0',
      }, // Y=4 时, (Y-1)/4=0, Y/4=1。L 值应为 0。
      {
        year: 2005,
        month: 1,
        term: 'lesser_cold' as SolarTermKey,
        expected: '2005-01-05',
        desc: '小寒 2005, Y=5, (Y-1)/4 = 1',
      }, // Y=5 时, (Y-1)/4=1, Y/4=1。L 值应为 1。
    ];

    test.each(testCases)(
      '应计算 $year-$month 的 $term ($desc) 为 $expected',
    ...
    const testCases = [
      {
        ...
        expected: baseExpected2024JanFeb,
        desc: 'Range covering Jan-Feb 2024',
      },
      {
        start: '2024-03-01',
        end: '2024-03-31',
      ...
      },
      {
        ...
        desc: 'Single day range on a solar term',
      },
      {
        start: '2024-01-06',
        end: undefined,
  ...
  describe('getSolarTermsInRange', () => {
    const defaultRangeTestCases = [
      ...
      },
      {
        ...
        desc: '跨年范围 2024年12月30日至2025年1月2日',
        expected: [
          {
            date: '2024-12-30',
            term: 'the_winter_solstice',
    ...
    test.each(defaultRangeTestCases)(
      'getSolarTermsInRange($start, $end) ($desc)',
      ({ start, end, expected }) => {
